const AccountDeletion = () => {
  return (
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif", maxWidth: 800, margin: '0 auto', padding: 20, lineHeight: 1.6, color: '#e0e0e0', backgroundColor: '#0a0a0a', minHeight: '100vh' }}>
      <h1 style={{ color: '#fff', borderBottom: '2px solid #2563eb', paddingBottom: 10 }}>Account Deletion Policy - BlueStone24</h1>
      ...
      <p>You can request the deletion of your BlueStone24 account and associated data by:</p>
      <ol>
        <li><strong>Email:</strong> Send a request to <a href="mailto:support@BlueStone24.com" style={{ color: '#2563eb' }}>support@BlueStone24.com</a> with the subject line "Account Deletion Request" from the email address associated with your account.</li>
      ...
      <ul>
        <li><strong>Email:</strong> <a href="mailto:support@BlueStone24.com" style={{ color: '#2563eb' }}>support@BlueStone24.com</a></li>
