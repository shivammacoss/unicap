          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-dark-800 rounded-xl p-6 border border-gray-700">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-black">Welcome to BlueStone</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="bg-dark-800 rounded-xl p-6 border border-gray-700">
                ...
                <button className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-gradient-to-r from-blue-500 to-cyan-500/90 flex items-center justify-center gap-2">
                  <Plus size={16} />
                  Create New Template
                </button>
              </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-dark-800 rounded-xl p-6 border border-gray-700">
                ...
                <div className="flex gap-2 mt-4">
                  <button className="flex-1 bg-blue-500 text-white px-3 py-2 rounded-lg text-sm">Edit</button>
                  <button className="flex-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-3 py-2 rounded-lg text-sm">Delete</button>
                </div>
              </div>
