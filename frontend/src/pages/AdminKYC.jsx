              ...
              <div className="space-y-4">
                {selectedKyc.frontImage && (
                  <div>
                    ...
                    <img 
                      src={selectedKyc.frontImage.startsWith('http') || selectedKyc.frontImage.startsWith('data:') ? selectedKyc.frontImage : `${API_BASE_URL}${selectedKyc.frontImage}`} 
                      alt="Front" 
                ...
                {selectedKyc.backImage && (
                  <div>
                    ...
                    <img 
                      src={selectedKyc.backImage.startsWith('http') || selectedKyc.backImage.startsWith('data:') ? selectedKyc.backImage : `${API_BASE_URL}${selectedKyc.backImage}`} 
                      alt="Back" 
                      className="max-w-full rounded-lg border border-gray-700" 
                    />
                  </div>
                ...
                {selectedKyc.selfieImage && (
                  <div>
                    ...
                    <img 
                      src={selectedKyc.selfieImage.startsWith('http') || selectedKyc.selfieImage.startsWith('data:') ? selectedKyc.selfieImage : `${API_BASE_URL}${selectedKyc.selfieImage}`} 
                      alt="Selfie" 
                      className="max-w-full rounded-lg border border-gray-700" 
                    />
                  </div>
