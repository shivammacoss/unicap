              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button 
                    ...
                    disabled={actionLoading}
                    className="flex-1 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg hover:bg-red-600 transition-colors disabled:opacity-50"
                  >
      ...
      <div className="flex gap-2 mb-4">
        ...
        >
          ...
          {resetRequestStats.pending > 0 && (
            <span className="px-2 py-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-xs rounded-full">{resetRequestStats.pending}</span>
          )}
        </button>
      </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              disabled={actionLoading}
                              className="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg hover:bg-red-600 text-sm disabled:opacity-50"
                            >
                              Reject
                            </button>
                          </div>
            ...
            filteredUsers.map((user) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500/20 rounded-full flex items-center justify-center">
