          ...
          <div>
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full bg-dark-600 border rounded-lg pl-11 pr-12 py-3 text-white placeholder-gray-500 focus:outline-none transition-colors ${fieldErrors.password ? 'border-red-500' : 'border-gray-700 focus:border-gray-600'}`}
              />
              <button
                type="button"
