        ...
        <div className="bg-gradient-to-br from-accent-green/20 to-dark-800 rounded-xl p-4 mb-4 border border-accent-green/30">
          ...
          <div className="flex gap-2 mt-3">
            <button 
              ...
              className="flex-1 flex items-center justify-center gap-1 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg text-sm font-medium"
            >
          ...
          {categories.map(cat => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm whitespace-nowrap ${
                activeCategory === cat ? 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white' : 'bg-dark-700 text-gray-400'
              }`}
            >
              {cat}
            </button>
              ...
              <div className="flex gap-2 mb-4">
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-sm font-medium ${
                    orderType === 'market' ? 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white' : 'bg-dark-700 text-gray-400'
                  }`}
                >
                  Market
                </button>
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-sm font-medium ${
                    orderType === 'pending' ? 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white' : 'bg-dark-700 text-gray-400'
                  }`}
                >
                  Pending
                </button>
