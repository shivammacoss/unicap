...
export default function FundingsPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-12 bg-gradient-to-b from-bluestone-deep via-bluestone-dark to-bluestone-dark relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="inline-flex bg-bluestone-deep/80 rounded-full p-1.5 border border-white/10 mb-8">
              <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-2">
              ...
              <button className="flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium text-white/50 hover:text-white/80 transition-colors">
