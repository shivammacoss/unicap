    ...
    <>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-bluestone-deep via-bluestone-dark to-bluestone-deep relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <button className="btn-primary px-8 py-4 text-lg bg-gradient-to-r from-gold to-gold-dark">
            Apply Now
          </button>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-gold/20 to-bluestone-accent/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl sm:text-4xl font-semibold text-white mb-4">
            Start your funded journey today.
          </h2>
          <p className="text-white/70 mb-8">Get access to exclusive trading capital with premium conditions.</p>
          <button className="btn-primary px-10 py-4 text-lg bg-gradient-to-r from-gold to-gold-dark">
            Get Funded
          </button>
        </div>
      </section>
