...
export default function ProFundPage() {
  const planDetails = [
    { label: 'Funding Amount', value: '$25,000', icon: DollarSign },
    { label: 'Profit Split', value: 'Up to 90%', icon: TrendingUp },
    { label: 'Max Drawdown', value: '12%', icon: Shield },
    { label: 'Daily Loss Limit', value: '6%', icon: AlertTriangle },
    ...
    <>
      ...
      <section className="pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="inline-block bg-purple-500/20 text-purple-400 text-xs font-semibold px-3 py-1 rounded-full mb-4">
            PRO PLAN
          </div>
          ...
          <p className="text-white/60 mb-8">Built for professional traders.</p>
          <button className="btn-primary px-8 py-4 text-lg bg-gradient-to-r from-purple-500 to-purple-600">
            Apply Now
          </button>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-purple-500/20 to-gold/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-display text-3xl sm:text-4xl font-semibold text-white mb-4">
            Start your funded journey today.
          </h2>
          <p className="text-white/70 mb-8">Get access to $25,000 in trading capital with up to 90% profit split.</p>
          <button className="btn-primary px-10 py-4 text-lg bg-gradient-to-r from-purple-500 to-purple-600">
            Get Funded
          </button>
        </div>
      </section>
